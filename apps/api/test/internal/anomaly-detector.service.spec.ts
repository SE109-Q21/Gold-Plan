...
describe('AnomalyDetectorService', () => {
  ...
  describe('isAnomalous', () => {
    ...
    it('returns false when previous price is zero', () => {
      expect(service.isAnomalous(0n, 8_500_000n)).toBe(false);
    });
  ...
  describe('getDeviationPercent', () => {
    ...
    it('returns 0 when prices are equal', () => {
      const result = service.getDeviationPercent(8_000_000n, 8_000_000n);
