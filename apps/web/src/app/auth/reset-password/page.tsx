      ...
      <div className={PAGE}>
        <div className={CARD}>
          <div className="text-center">
            ...
            <h1 className="font-display text-[24px] leading-[1.1] font-extrabold tracking-[-0.02em] text-chalk mt-3 m-0 capitalize">Liên kết không hợp lệ</h1>
      ...
      <div className={PAGE}>
        <div className={CARD}>
          <div className="text-center">
            ...
            <h1 className="font-display text-[24px] leading-[1.1] font-extrabold tracking-[-0.02em] text-chalk mt-3 m-0 capitalize">Mật khẩu đã cập nhật</h1>
    ...
    <div className={PAGE}>
      <div className={CARD}>
        <div className="text-center mb-7">
          ...
          <h1 className="font-display text-[24px] leading-[1.1] font-extrabold tracking-[-0.02em] text-chalk m-0 capitalize">Mật khẩu mới</h1>
